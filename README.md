...
<div align="center">
  ...
  **Languages & Data Science** ![Python](https://img.shields.io/badge/Python-3776AB?style=for-the-badge&logo=python&logoColor=white)
  ...
  **Cloud & DevOps** ![AWS](https://img.shields.io/badge/AWS-232F3E?style=for-the-badge&logo=amazon-aws&logoColor=white)
  ...
  | Resource | Course / Certification | Status |
  | :--- | :--- | :---: |
  | **UFC** | B.S. in Statistics | 🎓 2026 |
  | **Escola da Nuvem** | AWS Cloud Foundations (CLF-C02) | ☁️ *Learning* |
  | **DIO Bootcamp** | Azure Data Scientist (DP-100) | 🤖 *Learning* |
  | **Coursera** | Microsoft Python Developer | 🐍 *Learning* |
  | **Coursera** | Microsoft Data Visualization | 📈 *Learning* |
